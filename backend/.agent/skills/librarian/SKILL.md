---
name: Librarian
description: A skill to resolve Decentralized Identifiers (DIDs), search any information using ODRL services.
---
...
**Usage:**
```bash
python3 .agent/skills/librarian/scripts/resolve_did.py <DID_STRING>
```
...
**Usage:**
```bash
python3 .agent/skills/librarian/scripts/search_odrl.py <QUERY> <COLLECTION>
```

**Example:**
`python3 .agent/skills/librarian/scripts/search_odrl.py api dataverse`
